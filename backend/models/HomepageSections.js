...
const DEFAULT_SECTIONS = [
  ...
  { id: 'faq', enabled: true, order: 11, config: { pairs: [
  ...
  { id: 'newsletter', enabled: true, order: 12, config: { heading: 'Stay in the Loop', incentive: 'Get 10% off your first order when you subscribe!', placeholder: 'Enter your email address', ctaLabel: 'Subscribe' } },
