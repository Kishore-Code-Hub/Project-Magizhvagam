...
export default function Typewriter({
  ...
  return (
    <span className="inline-flex items-center text-accent font-mono font-bold tracking-wider text-base sm:text-lg md:text-xl lg:text-2xl break-words max-w-full">
      <span>&gt; {displayedText}</span>
      <span className="w-[3px] h-6 sm:h-7 bg-accent ml-1.5 animate-pulse flex-shrink-0" />
    </span>
  );
}
